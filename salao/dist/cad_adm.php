...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>          
            <h3><i class="fa fa-user" aria-hidden="true"></i> Cadastro de Administrador >> Informações pessoais</h3>
          </div>          
        </div>
        <div class="container" style="background-color:white; max-width:800px;">
                    <!--Formulário de cadastro de de dados pessoais-->     
                    <h3><i class="fa fa-user" aria-hidden="true"></i> Cadastro de Administrador >> Informações pessoais</h3>
                    <form class="form-horizontal" action="../Controller/cad_adm.php" method="POST" id="cad_adm" name="cad_adm">
                        <div class="form-group" style="margin-top:10px;">
                          ...
                          <div class="col-sm-3">                            
                            <input  class="form-control" id="cpf" type="text" name="cpf" placeholder="CPF" maxlength="14" OnKeyPress="formatar('###.###.###-##', this)" required> 
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3  control-label" style="padding-top:0px;" for="date">Data de Nascimento</label>
                          <div class="col-sm-3">
                            <input id="data" style="border-size:2px; border-color:#cccccc;border-style:solid; border-radius:2px;margin-top:5px;" type="date"  name="data" required>                          
                          </div>
                        </div>
						            <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label" for="inputPassword">Telefone</label>
                          <div class="col-sm-3">
                            <input class="form-control" id="tel" type="text"  name="tel" placeholder="Telefone" OnKeyPress="formatar('##-####-####', this);" maxlength="12" required>                            
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-3 control-label" for="inputPassword">Celular</label>
                          <div class="col-sm-3">
