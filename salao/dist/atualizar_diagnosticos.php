...
?>
      ...
      <div class="content-wrapper">        
        <div class="page-title" id="titulo">                    
          <h1><i class="fa fa-edit"></i> Lista de Diagnósticos</h1>          
        </div>
        <div class="page-title">
          <ul class="breadcrumb">              
            <li><a href="adm.php">Home</a></li>
            <li><a href="#">Lista de Diagnósticos</a></li>
          </ul>
        </div>
        <div class="row">
          <div class="col-md-8">
                      ...
                      if(mysqli_num_rows($result) == 0){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            echo "<tr><td>".$row['Nome']."</td><td>".$row['Funcionario']."</td><td>".$row['data']."</td><td class='actions'>
                                  ...
                                  <a class='btn btn-danger btn-xs' data-toggle='tooltip' data-placement='top' title='Deletar diagnóstico' onclick='cancelar(".$row['ID'].")'><i class='fa fa-trash-o' aria-hidden=true'></i></a>
                                  </td></tr>";                    
                        }
                        echo "</table>";                        
                        if($num_paginas > 1){
    ...
    <script type="text/javascript">
      ...
      function cancelar(id){
        var r = confirm("Você tem certeza que deseja apagar o diagnóstico?");
        if(r == true){
          alert('Diagnóstico deletado!');
