...
<!-- 13/05/2017-->
<?php
    $resultado = mysqli_query($conectar, "SELECT PE.NOME, C.CPF, DI.TEXTURA, DI.FORMA, DI.FIBRA, DI.CUTICULA, DI.QUEDA, DI.EMOCIONAL, DI.CatacterFisi AS 'CARACTERISTICA FISICA' , DI.COR, DI.COR, DI.FUNCIONARIO FROM PESSOA AS PE, CLIENTE AS C, DIAGNOSTICO AS DI WHERE PE.CPF=C.CPF AND C.CPF='".$_SESSION['usuario_cpf']."' AND C.ID=DI.ID_CLIENTE");
                  ...
                  <tbody>
                      ...
                      <?php
                        ...
                        echo "<tr>";
                                ...
                                echo "<td>".$linhas['CARACTERISTICA FISICA']."</td>";   
