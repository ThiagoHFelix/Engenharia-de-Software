        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-edit"></i>Alterar Cadastro de Professor</h1>
                    ...
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li>Alterar</li>
                            <li>Alterar Cadastro De Professor</li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="container">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h3 class="panel-title">Professor Cadastrados</h3>
                                        ...
                                        <form class="form-horizontal">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"> 
                                                        <input type="text" class="form-control" id="pwd" value="Pedro Alves">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-2" for="email">Email:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="email" value="Pedro@hotmail.com" maxlength="11">
                                                    </div>
                                                </div>
