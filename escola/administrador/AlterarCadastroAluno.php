        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-edit"></i>Alterar Cadastro de Aluno</h1>
                    ...
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li>Alterar</li>
                            <li>Alterar Cadastro De Aluno</li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="well bs-component">
                                        <legend>Alterar Cadastro de Aluno</legend>
                                        <div class="container">
                                        ...
                                        <form class="form-horizontal">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"> 
                                                        <input type="text" class="form-control" id="pwd" value="João Perreira">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-sm-2" for="email">Email:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="email" value="João@hotmail.com">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2"> 
                                                        <input type="password" class="form-control" value="(19)3626-1328">
                                                    </div>
                                                </div>
                                                <div class="form-group">
