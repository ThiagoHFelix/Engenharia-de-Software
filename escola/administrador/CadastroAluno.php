                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="well bs-component">
                                        <form class="form-horizontal" method="GET" action="cadAluno.php">
                                            <fieldset>
                                                ...
                                                <div class="fcol-sm-4 myclass" style="margin:0px 15px 0px 15px;">
                                                        <label for="comment">Qualificações</label>
                                                        <textarea class="form-control" rows="5" placeholder="Qualificações" id="comment"></textarea>
                                                    </div>
